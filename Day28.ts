...
function lengthOfString(line3: string) {
  return line3.length;
}
console.log(
  lengthOfString("Your mouth can be a barrier between you and your success")
);
//question 83
function cases(line4: string): void {
...
function replacement(line5: string): string {
  return line5.replace(/your/g, "our");
}
console.log(
  replacement("your mouth can be a barrier between you and your success")
);